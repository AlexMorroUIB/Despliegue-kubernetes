const dbbox = document.getElementById('dbstatus')
const cachebox = document.getElementById('cachestatus')
const tabla = document.getElementById('tabla')
const tablaRedis = document.getElementById('tablaRedis')
